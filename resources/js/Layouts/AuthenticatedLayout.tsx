                ...
                <div className="mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex h-16 justify-between">
                        <div className="flex w-full">
                            ...
                            <div className="hidden flex-1 space-x-1 sm:-my-px sm:ms-10 sm:flex">
                                {activeTab !== undefined && setActiveTab ? (
                                    <>
                                        <button
                                            ...
                                            } inline-flex items-center border-b-2 px-4 pt-1 text-sm font-medium transition duration-150 ease-in-out focus:outline-none`}
                                        >
                                            Dashboard
                                        </button>
                                        <button
